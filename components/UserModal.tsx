  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center bg-slate-900/60 backdrop-blur-sm p-4 animate-in fade-in duration-200 overflow-y-auto">
      <div className="bg-white rounded-[2.5rem] p-8 max-w-md w-full shadow-2xl animate-in zoom-in-95 duration-300 relative">
        ...
        <div className="mb-8">
          <h3 className="text-2xl font-black text-slate-800 tracking-tight">Registrar Nuevo Usuario</h3>
          <p className="text-slate-400 text-xs font-black uppercase tracking-widest mt-1">Crear una nueva cuenta de usuario</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div className="flex gap-4 pt-4">
            ...
            <button 
              type="submit" 
              className="flex-[2] bg-[#1E1E2D] text-white py-4 rounded-xl font-black text-[10px] uppercase tracking-[0.2em] shadow-xl hover:bg-black transition-all"
            >
              Confirmar Registro
            </button>
          </div>
